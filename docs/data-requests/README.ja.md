...
| [0004](0004-flash-program-method.ja.md) | main flash の消去/書き込み**手順**の family 別分類 | **納品受け入れ・消費済** | 中 |
| — | **flash 消去後の読み出し値**(系統 A `0xFFFFFFFF` / B `0xe339e339`) | `wch-protocols` から依頼(R-31)→ **納品受け入れ・消費済**(V103 の値は[こちらの実測](measured/erased-read-2026-09-06.md)が DB の basis に採用された) | 中 |
