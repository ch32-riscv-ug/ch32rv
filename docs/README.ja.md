...
| [testing.ja.md](testing.ja.md) | 全 OS の実機テスト手順(Linux 先行→Windows/macOS 追試)。read-only / flash 往復 / 走行の 3 tier。転送用 fixture(pattern + family 別 runtest)は `tests/fixtures/` |
